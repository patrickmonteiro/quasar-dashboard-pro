...
export default defineConfig((/* ctx */) => {
  return {
    ...
    extras: [
      ...
      // 'roboto-font' dropped — Inter (via @fontsource-variable/inter, see app.scss) is the
      // app's default typeface now.
      'material-symbols-outlined', // thinner, more elegant icon set than material-icons
    ],
